...
namespace EventAssistant
{
    public partial class DialogBox : Window
    {
        ...
        /// Button1 text.
        /// </summary>
        public string ButtonText1 { get; private set; } = "No";

        /// <summary>
        /// Button2 text.
        /// </summary>
        public string ButtonText2 { get; private set; } = "Ok!";

        /// <summary>
        /// Button3 text.
        /// </summary>
        public string ButtonText3 { get; private set; } = "Yes";
        ...
        /// </summary>
        public DialogBox()
        : this(DialogBoxType.INFORMATION, "SUCCESS!", "Operation Successfull!") { }
        ...
        : this(DialogBoxType.INFORMATION, "SUCCESSS!", message) { }
        ...
        /// <summary>
        /// Responds according to the given answer.
